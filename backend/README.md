...
VALUES ('Admin', 'User', 'admin@inyou.luxury', '$2b$12$WHwSscyZYwedEExVGXDsQuUWEre6YFpVvx9ebEL0v2E70.k59hoQy', TRUE);
```
(This creates admin@inyou.luxury with password: Inyou@123)
