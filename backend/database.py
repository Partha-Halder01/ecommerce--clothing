...
def init_database():
    ...
    try:
        ...
        cursor.execute("""
            ...
            ('sale_banner', '{"enabled": true, "text": "LIMITED TIME OFFER - UP TO 20% OFF SIGNATURE SCENTS", "end_date": "2026-12-31T23:59:59"}')
        """)
        cursor.execute("""
            INSERT IGNORE INTO site_settings (setting_key, setting_value) VALUES 
        ...
        cursor.execute("""
            INSERT IGNORE INTO site_settings (setting_key, setting_value) VALUES 
            ('hero_slides', '{"slides": [{"title": "The Art of Fragrance", "subtitle": "Signature Collection", "description": "Discover our most coveted scents, crafted for the extraordinary.", "image": "https://images.unsplash.com/photo-1541643600914-78b084683601?q=80&w=1920&auto=format&fit=crop", "cta": "Explore Scents", "href": "/shop"}, {"title": "Nocturnal Elegance", "subtitle": "Limited Edition", "description": "Deep, mysterious, and unforgettable. The essence of the night.", "image": "https://images.unsplash.com/photo-1594035910387-fea47794261f?q=80&w=1920&auto=format&fit=crop", "cta": "Shop Now", "href": "/shop"}, {"title": "Timeless Presence", "subtitle": "Luxury Gifting", "description": "Gift the unforgettable experience of Inyou Luxury.", "image": "https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?q=80&w=1920&auto=format&fit=crop", "cta": "Gift Guide", "href": "/shop"}], "recommended_size": "1920x1080"}')
        """)
        cursor.execute("""
            INSERT IGNORE INTO site_settings (setting_key, setting_value) VALUES 
            ('shop_the_look', '{"enabled": true, "title": "Trending Fragrances", "product_ids": []}')
        """)
        cursor.execute("""
            INSERT IGNORE INTO site_settings (setting_key, setting_value) VALUES 
            ('scrolling_text', '{"enabled": true, "text": "FREE SHIPPING ON ORDERS ABOVE ₹2000 | 100% AUTHENTIC LUXURY FRAGRANCES | SECURE PAYMENT GATEWAY"}')
        """)
