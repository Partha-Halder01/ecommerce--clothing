      ...
      <main className="py-12">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl lg:text-4xl font-semibold mb-8">My Orders</h1>
                          ...
                          {orderItems.length === 0 ? (
                            ...
                            orderItems.map((item: any, index: number) => (
                              <div key={index} className="flex gap-4">
                                <div className="relative w-20 h-24 rounded-sm overflow-hidden bg-muted shrink-0">
                                  <Image
                                ...
                                <div>
                                  ...
                                  <p className="text-sm mt-1" style={{ fontFamily: "var(--font-inter)" }}>
                                    ₹{item.price?.toFixed(0) || "0"} x {item.quantity || 1}
                                  </p>
                                </div>
                              </div>
                            ))
