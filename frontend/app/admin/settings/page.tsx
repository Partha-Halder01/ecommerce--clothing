...
export default function AdminSettings() {
  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-2xl sm:text-3xl font-light text-[#1C1615] uppercase tracking-widest" style={{ fontFamily: "var(--font-playfair)" }}>Settings</h1>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
            ...
            <div className="flex items-center gap-2">
              <span className={`text-sm ${paymentSettings.cod_enabled ? 'text-green-600' : 'text-[#6B635E]'}`}>
          ...
          <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-blue-100 rounded-lg">
                <CreditCard className="h-5 w-5 text-[#D8B4A0]" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-2">
              <span className={`text-sm ${paymentSettings.online_enabled ? 'text-green-600' : 'text-[#6B635E]'}`}>
