    ...
    return (
        <div className="p-8 max-w-5xl">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-light text-[#1C1615] uppercase tracking-widest" style={{ fontFamily: "var(--font-playfair)" }}>Hero Settings</h1>
                ...
                <CardContent className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                        ...
                        <div className="flex items-center gap-2">
                            <span className={`text-sm ${saleBanner.enabled ? 'text-green-600' : 'text-[#6B635E]'}`}>
                    ...
                    <div className="p-4 border rounded-lg">
                        ...
                        <div className={`bg-[#1C1615] text-white py-2 px-4 rounded flex items-center justify-center gap-4 ${!saleBanner.enabled && 'opacity-50'}`}>
            ...
            <Card className="mb-6 bg-blue-50 border-blue-200">
                <CardContent className="py-4 flex items-start gap-3">
                    <Info className="h-5 w-5 text-[#D8B4A0] mt-0.5" />
                    <div>
